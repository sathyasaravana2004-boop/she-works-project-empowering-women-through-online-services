// // src/pages/provider/EditProviderProfile.jsx
...
//           <div className="image-preview-container">
//             {images.map((src, i) => (
//               <img key={i} src={src} alt={`existing-${i}`} className="preview-image" />
//             ))}
//             {previewNew.map((src, i) => (
//               <img key={`new-${i}`} src={src} alt={`new-${i}`} className="preview-image" />
//             ))}
//           </div>
//         </div>
